        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('lote_pagto', $pagamento->pag_lote, ['disabled'=>'disabled','id'=>'lote_pagto', 'class'=>'form-control']) !!}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    {!! Form::label('Numero do Terminal usado no Pagamento ( informado no comprovante )') !!}
                    {!! Form::text('terminal_pagto', $pagamento->pag_terminal, ['disabled'=>'disabled','id'=>'terminal_pagto', 'class'=>'form-control']) !!}
                </div>
                <div class="form-group">
